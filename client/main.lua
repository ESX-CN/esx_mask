local Keys = {
	...
	["ENTER"] = 18,["CAPS"] = 137,["A"] = 34,["S"] = 8,["D"] = 9,["F"] = 23,["G"] = 47,["H"] = 74,["K"] = 311,["L"] = 182,["LEFTSHIFT"] = 21,
	["Z"] = 20,["X"] = 73,["C"] = 26,["V"] = 0,["B"] = 29,["N"] = 249,["M"] = 244,[","] = 82,["."] = 81,
	["LEFTCTRL"] = 36,["LEFTALT"] = 19,["SPACE"] = 22,["RIGHTCTRL"] = 70,["HOME"] = 213,["PAGEUP"] = 10,["PAGEDOWN"] = 11,
	["DELETE"] = 178,["LEFT"] = 174,["RIGHT"] = 175,["TOP"] = 27,["DOWN"] = 173,["NENTER"] = 201,["N4"] = 108,
			...
			if data.current.value == 'yes' then
				ESX.TriggerServerCallback('esx_mask:checkMoney',function(hasEnoughMoney)
					if hasEnoughMoney then
						...
						TriggerEvent('skinchanger:getSkin',function(skin) TriggerServerEvent('esx_mask:saveMask', skin) end)
					else
						TriggerEvent('esx_skin:getLastSkin',function(skin) TriggerEvent('skinchanger:loadSkin', skin) end)
    ...
    while true do
        ...
        if CurrentAction ~= nil then
            ...
            if IsControlPressed(0, Keys['E']) and (GetGameTimer() - GUI.Time) > 300 then
                if CurrentAction == 'shop_menu' then OpenShopMenu() end
                CurrentAction = nil
        ...
        if IsControlPressed(0, Keys['LEFTSHIFT']) and IsControlPressed(0, Keys['M']) and not IsDead and (GetGameTimer() - GUI.Time) > 300 then
			...
			TriggerEvent('skinchanger:getSkin',function(skin)
				ESX.TriggerServerCallback('esx_mask:getMask',function(hasMask, maskSkin)
						if hasMask then
							TriggerEvent('skinchanger:loadClothes',skin,{mask_1 = maskSkin.mask_1, mask_2 = maskSkin.mask_2})
...
RegisterNetEvent('esx:showMaskNotification')
AddEventHandler('esx:showMaskNotification', function(msg,...)
